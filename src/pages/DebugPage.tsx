...
export function DebugPage() {
  ...
  return (
    <main className="app-shell debug-layout">
      <section className="hero-panel">
        <p className="eyebrow">Generator Workbench</p>
        <h1>Debug and tune generation behavior.</h1>
        <p className="hero-copy">
          Use this internal page to inspect generated cards, seeds, and
          structural validation details while iterating on heuristics.
        </p>
        <CardControls
          seed={seed}
          setCount={setCount}
